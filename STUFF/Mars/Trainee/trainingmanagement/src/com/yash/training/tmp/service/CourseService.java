...
public class CourseService implements CourseServiceLocal {
	...
	public List<Course> fetchTotalActiveCourses() {
		String sql = "SELECT * FROM CREATECOURSE WHERE COURSE_STATUS=1";
	...
	public void changeCourseStatus(int subheadingIdReceived , String selectedCourseStatus) {
		String query = "UPDATE SUBHEADING SET SUBHEADING_STATUS = '" + selectedCourseStatus + "' WHERE SUBHEADING_ID = " + subheadingIdReceived;
		try {
			DButil.update(query);
		} catch (Exception e) {
			// TODO Auto-generated catch block
