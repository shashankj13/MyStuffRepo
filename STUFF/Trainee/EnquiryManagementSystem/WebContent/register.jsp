...
<body bgcolor="lightblue">
	...
	<center>
		<form method="GET" action="RegisterActionServlet">
			<table border="1" height="300px" width="500px">
				...
				<tr>
					...
					<td align="center"><input class="h" type="text" name="email">
					</td>
				</tr>

				<tr>
					<td align="center">Enter type :</td>
					<td align="center"><input class="h" type="text" name="type">
					</td>
				</tr>

				<tr>
					<td align="center">Enter status :</td>
					<td align="center"><input class="h" type="text" name="status">
					</td>
				</tr>
